...
CKPT_FLAGS="--out_dir /ctm/gan2 --ref_path=/ctm/author_ckpt/VIRTUAL_lsun_bedroom256.npz  --teacher_model_path=/ctm/author_ckpt/edm_bedroom256_ema.pt --resume_checkpoint=/ctm/lsuncode_refactor/model021000.pt --data_dir=/ctm/dataset/LSUN_Bedroom/train_orig_imgs --total_training_steps=50000"
