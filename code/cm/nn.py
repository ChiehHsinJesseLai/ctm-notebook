...
class GroupNorm32(nn.GroupNorm):
    """
    Group Normalization with 32-bit floating point precision.
    This class extends the PyTorch GroupNorm class to ensure that the input
    tensor is converted to 32-bit floating point precision before normalization.
    """
    def forward(self, x):
        """
        Apply group normalization to the input tensor with 32-bit precision.
        """
