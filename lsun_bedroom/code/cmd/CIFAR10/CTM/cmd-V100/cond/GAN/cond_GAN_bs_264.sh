...
mpiexec -n 4 python3.11 cm_train.py $MODEL_FLAGS --global_batch_size=264 --out_dir /groups/gce50978/user/dongjun/EighthArticleExperimentalResults/CIFAR10/GAN/cond/GAN_bs_264/