...
class _FusedMultiplyAdd(torch.autograd.Function):
    """
    Custom autograd function for fused multiply-add operation.
    """
    @staticmethod
    def forward(ctx, a, b, c):
        """
        Forward pass for fused multiply-add operation.
        """
    ...
    def backward(ctx, dout):
        """
        Backward pass for fused multiply-add operation.
        """
...
def _unbroadcast(x, shape):
    """
    Unbroadcast a tensor to a specified shape.
    """
