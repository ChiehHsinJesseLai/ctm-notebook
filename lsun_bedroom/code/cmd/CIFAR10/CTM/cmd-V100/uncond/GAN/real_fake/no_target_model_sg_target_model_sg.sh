...
mpiexec -n 4 python3.11 cm_train.py --out_dir /home/acf15618av/EighthArticleExperimentalResults/CIFAR10/ablation-V100/GAN/real_fake/GAN_no_target_model_sg_target_model_sg/ --gan_real_inner_type=target_model_sg --gan_real_free=False --gan_training=True --g_learning_period=2 --resume_checkpoint=/home/acf15618av/EighthArticleExperimentalResults/CIFAR10/resume_checkpoint/euler_edm_stop_grad_random_17_M_bs_384_from_edm_dsm_1.0/model050000.pt --microbatch=11 --global_batch_size=132