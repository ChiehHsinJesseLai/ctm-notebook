...
mpiexec -n 4 python3.11 cm_train.py $MODEL_FLAGS --heun_step_multiplier=-1.0 --weight_schedule=uniform_g --weight_schedule_multiplier=1.0 --rescaling=False --diffusion_training_frequency=0.2 --out_dir /home/acf15618av/EighthArticleExperimentalResults/CIFAR10/large_NFE/h-1w1rFp2/