...
class CMTrainLoop(TrainLoop):
    ...
    def forward_backward(self, batch, cond):
        ...
        # print("diffusion_training_, gan_training_",diffusion_training_,gan_training_)
        # if dist.get_rank() == 0:
        # # Rank 0 is the source process, it has the original data.
        #     data = [{'a': 1, 'b': 2}, [3, 4, 5], 'hello world', 1234, 3.14]
        # else:
        # # All other processes have empty list.
        #     data = [None, None, None, None, None]
        # print("befor calling")
        # device = th.device("cuda", int(dist.get_rank()))
        # print(device)
        # dist.broadcast_object_list(data, src=0,device=device)
        # print("after calling")
