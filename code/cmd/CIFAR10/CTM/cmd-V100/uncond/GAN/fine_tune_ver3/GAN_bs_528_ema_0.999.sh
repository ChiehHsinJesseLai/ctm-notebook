...
mpiexec -n 4 python3.11 cm_train.py $MODEL_FLAGS --global_batch_size=528 --out_dir /home/acf15618av/EighthArticleExperimentalResults/CIFAR10/ablation-V100/GAN/fine_tune_ver3/GAN_bs_528_ema_0.999/