...
def load_data(
    *,
    ...
    if train_classes == 281:
        ...
        class_names = {'n01440764': 0, 'n01443537': 1, 'n01518878': 9, 'n01531178': 11,
                    'n01632777': 29, 'n01644373': 31,'n01664065': 33, 'n01729977': 55,
                    'n01774750': 76, 'n01819313': 89, 'n01820546': 90, 'n02007558': 130,
                   'n02099601': 207, 'n02110185': 250, 'n02120079': 279, 'n02123045': 281,
                    'n02129165': 291, 'n02279972': 323,'n02504458': 386, 'n02509815': 387,
                    'n02510455': 388, 'n02782093': 417, 'n03388043': 562, 'n03617480': 614,
                   'n04069434': 759, 'n04201297': 789, 'n04243546': 800, 'n04266014': 812,
                    'n04392985': 848, 'n07697313': 933,'n09256479': 973, 'n09472597': 980}
        all_files = []
        classes = []
...
def _list_image_files_recursively(data_dir, type='jpeg'):
    """
    Recursively lists image files in a directory.
    """
    results = []
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        """
        Retrieves an image and its corresponding label (if available) at the specified index.
        """
        ...
        if self.type == 'npy':
            ...
            if self.data_name != "lsun_bedroom":
                if self.random_crop:
                ...
                if self.random_flip and random.random() < self.flip_ratio:
                    arr = arr[:, ::-1]              
                ## To check whether to include in LSUN Bedroom
                ...
                h, w, _ = arr.shape
                h_off = (h - self.resolution) // 2
                w_off = (w - self.resolution) // 2
                arr = arr[h_off : h_off + self.resolution, w_off : w_off + self.resolution]
                if self.random_crop:
                    arr = random_crop_arr(Image.fromarray(arr), self.resolution)
                else:
                    arr = center_crop_arr(Image.fromarray(arr), self.resolution)
