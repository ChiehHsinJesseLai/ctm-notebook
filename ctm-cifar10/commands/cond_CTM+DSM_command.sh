...
MODEL_FLAGS="--save_interval=10000 --check_dm_performance=False --eval_fid=True --eval_similarity=False --eval_interval=10000 --microbatch 16 --global_batch_size=256 --class_cond=True --teacher_model_path=/home/acf15618av/EighthArticleExperimentalResults/CIFAR10/author_ckpt/edm-cifar10-32x32-cond-vp.pkl --ref_path=/workspace/ctm/ctm-cifar10_cond/weight/cifar10-32x32.npz --self_learn=True --data_dir=/workspace/ctm/cifar10_images"

mpiexec --allow-run-as-root -n 1 python3 cm_train.py $MODEL_FLAGS --out_dir /workspace/ctm-cifar10/output
