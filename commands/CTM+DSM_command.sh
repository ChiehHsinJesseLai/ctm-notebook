...
CKPT_FLAGS="--out_dir ./results --ref_path=./VIRTUAL_lsun_bedroom256.npz --teacher_model_path=./edm_bedroom256_ema.pt --data_dir=./LSUN_Bedroom/train_orig_imgs  --total_training_steps=21000"
