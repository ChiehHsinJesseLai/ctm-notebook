...
mpiexec -n 1 --allow-run-as-root python /home/sard/CTM_project/CTM/code/image_sample.py $MODEL_FLAGS --class_cond=False --num_classes=0 --out_dir /home/sard/CTM_project/CTM/LSUN_Bedroom_Output --model_path=/home/sard/CTM_project/CTM/author_ckpt/cd_bedroom256_lpips.pt --training_mode=edm --class_cond=False --eval_num_samples=6400 --batch_size=800 --device_id=0 --stochastic_seed=True --save_format=npz --ind_1=36 --ind_2=20 --use_MPI=True --sampler=exact --sampling_steps=1 > log.txt