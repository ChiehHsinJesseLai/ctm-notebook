...
MODEL_FLAGS="--log_interval=100 --save_check_period=1000 --eval_interval=5000 --eval_fid=True --eval_similarity=False --check_dm_performance=False --compute_ema_fids=True --gan_fake_inner_type=model --gan_fake_outer_type=target_model_sg --gan_training=True --g_learning_period=2 --resume_checkpoint=/home/acf15618av/EighthArticleExperimentalResults/CIFAR10/resume_checkpoint/euler_edm_stop_grad_random_17_M_bs_384_from_edm_dsm_1.0/model050000.pt --microbatch=11"

mpiexec -n 4 python3.11 cm_train.py $MODEL_FLAGS --global_batch_size=264 --out_dir /home/acf15618av/EighthArticleExperimentalResults/CIFAR10/ablation-V100/GAN/fine_tune_ver3/GAN_bs_264_ema_0.999/