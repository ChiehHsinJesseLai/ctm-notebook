...
class Conv2dLayer(torch.nn.Module):
    ...
    def __init__(self,in_channels,out_channels,kh, kw, stride=1, padding=0):
        """
        Initialize the Conv2dLayer with input/output channels, 
...
class InceptionA(torch.nn.Module):
    """
    InceptionA module with multiple convolutional towers.
    """
    def __init__(self, in_channels, tmp_channels):
        """
        Initialize the InceptionA module with input channels and temporary channels.
        """
        super().__init__()
    ...
    def forward(self, x):
        """
        Forward pass through the InceptionA module.
        """
        return torch.cat(
            [
...
class InceptionB(torch.nn.Module):
    """
    InceptionB module with convolutional and pooling layers.
    """
    def __init__(self, in_channels):
        """
        Initialize the InceptionB module with input channels.
        """
        super().__init__()
    ...
    def forward(self, x):
        """
        Forward pass through the InceptionB module.
        """
        return torch.cat(
            [
                self.conv(x).contiguous(),
...
class InceptionC(torch.nn.Module):
    """
    InceptionC module with multiple convolutional towers.
    """
    def __init__(self, in_channels, tmp_channels):
        """
        Initialize the InceptionC module with input channels and temporary channels.
        """
        super().__init__()
    ...
    def forward(self, x):
        """
        Forward pass through the InceptionC module.
        """
        return torch.cat(
            [
                self.conv(x).contiguous(),
...
class InceptionD(torch.nn.Module):
    """
    InceptionD module with convolutional and pooling layers.
    """
    def __init__(self, in_channels):
        """
        Initialize the InceptionD module with input channels.
        """
        super().__init__()
        self.tower = torch.nn.Sequential(
            collections.OrderedDict(
    ...
    def forward(self, x):
        """
        Forward pass through the InceptionD module.
        """
        return torch.cat(
            [
                self.tower(x).contiguous(),
...
class InceptionE(torch.nn.Module):
    """
    InceptionE module with multiple convolutional towers and optional pooling.
    """
    def __init__(self, in_channels, use_avg_pool):
        """
        Initialize the InceptionE module with input channels and pooling option.
        """
        super().__init__()
    ...
    def forward(self, x):
        """
        Forward pass through the InceptionE module.
        """
        a = self.tower_conv(x)
...
class InceptionV3(torch.nn.Module):
    """
    InceptionV3 model with multiple convolutional and pooling layers.
    """
    def __init__(self):
        """
    ...
    def acts_to_probs(self, features, no_output_bias: bool = False):
        """
        Convert activations to probabilities using the output layer.
        """
        if no_output_bias:
    ...
    def create_softmax_model(self):
        """
        Create a softmax model using the output layer's weights.
        """
...
class SoftmaxModel(torch.nn.Module):
    """
    Softmax model for converting activations to probabilities.
    """
    def __init__(self, weight: torch.Tensor):
        """
        Initialize the SoftmaxModel with the given weights.
        """
        super().__init__()
    ...
    def forward(self, x):
        """
        Forward pass through the SoftmaxModel.
        """
