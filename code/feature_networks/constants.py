"""
Lists of model names grouped by different categories.
The models include those from TorchVision, RegNet, EfficientNet, 
Vision Transformer (ViT), and CLIP.
The lists are further grouped based on input normalization for ImageNet, Inception, and CLIP.
"""
TORCHVISION = [
    "vgg11_bn",
    "vgg13_bn",
