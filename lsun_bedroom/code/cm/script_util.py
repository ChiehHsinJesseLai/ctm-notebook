...
def cm_train_defaults(data_name):
    return dict(
        ...
        teacher_model_path="/home/acf15618av/EighthArticleExperimentalResults/CIFAR10/author_ckpt/edm-cifar10-32x32-uncond-vp.pkl" if data_name == 'cifar10' \
            else "/home/pranay_sard/CTM_project/CTM/author_ckpt/cd_bedroom256_lpips.pt" if data_name == "lsun_bedroom" else "",
