"""
The script is used to plot the ctm loss and dsm graphs
Give the path of the progress.csv file
"""
import pandas as pd
...
lst_value1 = [0.334084216, 0.050933401,	0.948485108, 0.809671388,
              59.84496723, 9.2495, 936.1426529, 256512, 500]
lst_value2 = [0.225401916, 0.04920471, 0.998657867, 0.836021385,
              40.87773986, 9.7495, 936.1586388,	512512,	1000]
lst_keys = ["consistency_loss mean", "consistency_loss std",
            "denoising_loss mean",	"denoising_loss std", "grad_norm",
